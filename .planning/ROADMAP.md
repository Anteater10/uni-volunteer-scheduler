...
| 35 | Broadcast footer + unsubscribe links | Both broken in every email sent | Fix both | L6 | **Done — PR #130.** Manage tokens are minted at send time (only hashes are stored), per recipient for broadcasts. Left a growth follow-up: #144 |
